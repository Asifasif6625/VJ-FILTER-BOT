...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001515300956 -1001442438880').split()]  # For Multiple Id Use One Space Between Each.
