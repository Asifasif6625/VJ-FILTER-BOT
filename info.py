...
PICS = (environ.get('PICS', 'https://files.catbox.moe/zck4ym.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '876045456').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001626276604'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001515300956 -1002757287228').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002277765668') # give your force subscribe channel id here else leave it blank
...
ANNOUNCEMENT_DOWNLOAD_BUTTON_TEXT = environ.get('ANNOUNCEMENT_DOWNLOAD_BUTTON_TEXT', 'ԃσɯɳʅσαԃ ɱσʋιҽ')
ANNOUNCEMENT_MOVIE_BUTTON_TEXT = environ.get('ANNOUNCEMENT_MOVIE_BUTTON_TEXT', environ.get('ANNOUNCEMENT_DOWNLOAD_BUTTON_TEXT', 'ԃσɯɳʅσαԃ ɱσʋιҽ'))
ANNOUNCEMENT_SERIES_BUTTON_TEXT = environ.get('ANNOUNCEMENT_SERIES_BUTTON_TEXT', environ.get('ANNOUNCEMENT_DOWNLOAD_BUTTON_TEXT', 'ԃσɯɳʅσαԃ ɱσʋιҽ'))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrsr:mrsr@cluster0.snp685y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://mrmv:mrmv@mrmv.djlwzyk.mongodb.net/?retryWrites=true&w=majority&appName=mrmv")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://data2mrmv:data2mrmv@cluster3.p8tqukm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster3")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://data5mrmv:data5mrmv@cluster5.t5ollhs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster5")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://data5mrmv:data5mrmv@cluster5.t5ollhs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster5") # Necessary If clone mode is true
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mv_requst_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/malayalam_vibe')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Missmiya_bot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Missmiya_bot')
...
TMDB_DATA = bool(environ.get('TMDB_DATA', True))
