...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '876045456 35676578 443564343').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'malayalam_vibe') # Support Chat Link Without https:// or @
